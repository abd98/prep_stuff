...
<div class="page">
    ...
    <div class="section features">
        ...
        <div id="tests" class="hvr-ripple-out"><i class="fa fa-lightbulb-o fa-3x" aria-hidden="true" style="color:black"></i>
</div>
        <div><h1>IDEATE</h1></div>
        <div><p >Lorem ipsum dollis nostra aut,<br> t praesent dolor magna risus.</p></div>

        </div>
        <div class="feature feature-2">
        <div id="tests" class="hvr-ripple-out"><i class="fa fa-users fa-3x" aria-hidden="true"></i>
</div>
        <div><h1>INNOVATE</h1></div>
        <div><p>Lorem ipsum dolonostra aut,<br> dolor magna risus. Dui sceleris</p></div>
        </div>
        <div class="feature feature-3">
        <div id="tests" class="hvr-ripple-out"><i class="fa fa-cogs fa-3x" aria-hidden="true"></i>
</div>
        <div><h1>BUILD</h1></div>
        <div><p >Lorem ipsum dolor s et rhonrrmat<br> praesr magna risus. Dui scelerisque </p></div>
...
<div class='application'>
  <div class='about'><h1 style="  text-shadow: 0 1px 0 #ccc,
               0 2px 0 #c9c9c9,
               0 3px 0 #bbb,
               0 4px 0 #b9b9b9,
               0 5px 0 #aaa,
  ...
  <div class='apply'><h1>APPLY</h1>
  <button type = "button" class = "btn btn-info btn-lg hvr-float-shadow">Apply</button></div>
